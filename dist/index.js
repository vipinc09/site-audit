...
class SiteChecker {
    ...
    async checkUrlStatus(urls) {
        ...
        const filePath = path.join(this.config.resultsFolder, "non-200-responses.json");
        await fs.writeFile(filePath, JSON.stringify(errorResponses, null, 2), "utf8");
    ...
    async checkAllNetworkRequests(context, urls) {
        ...
        const filePath = path.join(this.config.resultsFolder, "network-failures.json");
